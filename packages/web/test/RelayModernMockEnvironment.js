...
const areEqual = require('./areEqualOSS');
...
type OperationMockResolver = (operation: OperationDescriptor) => ?GraphQLSingularResponse | ?Error;
...
|}): RelayMockEnvironment {
  ...
  const createExecuteProxy = (
    env: IEnvironment,
    fn: $PropertyType<IEnvironment, 'execute'> | $PropertyType<IEnvironment, 'executeMutation'>,
  ) => {
